...
import {
  Stack, Grid, Cluster, Sidebar, Box, Hero, Dashboard,
...
export const HeroTemplate = (args) => (
  <Hero variant={args.variant} as={args.as}>
    <Heading level={1}>Welcome to Duro</Heading>
    <Paragraph>A HUD tech interface component library for React</Paragraph>
    <Cluster>
...
export const DashboardTemplate = (args) => (
  <Dashboard variant={args.variant} as={args.as} style={{ minHeight: '400px' }}>
    <Card style={{ gridArea: 'header' }}>
    ...
    <Card style={{ gridArea: 'main' }}>
      ...
      <CardContent>
        <Paragraph>Your dashboard content goes here</Paragraph>
      </CardContent>
    </Card>
    <Card style={{ gridArea: 'footer' }}>
...
The Hero component creates full-width hero sections for landing pages and feature highlights.
...
<Canvas>
  <Story
    ...
    argTypes={{
      variant: {
        control: { type: 'select' },
        options: [undefined, 'centered', 'split'],
        description: 'Hero layout variant',
      },
      as: {
        control: { type: 'select' },
        options: ['div', 'section', 'header'],
        description: 'HTML element to render',
      },
    }}
  >
...
The Dashboard component creates grid-based dashboard layouts with named areas.
...
<Canvas>
  <Story name="Hero Split">
    <Hero variant="split">
      <div>
        <Heading level={2}>Build HUD Interfaces</Heading>
        <Paragraph>
          Duro provides composable components with a monochromatic aesthetic.
          Perfect for tech dashboards, data visualization, and futuristic UIs.
        </Paragraph>
        <Button variant="primary" size="lg">Explore Components</Button>
      </div>
      <Card style={{ width: '100%', maxWidth: '300px', aspectRatio: '4/3' }}>
        <CardContent style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
          <Paragraph variant="small" style={{ textAlign: 'center' }}>Visual content or demo</Paragraph>
        </CardContent>
      </Card>
    </Hero>
  </Story>
  ...
  <Story name="Dashboard Admin">
    <Dashboard variant="admin" style={{ minHeight: '400px' }}>
      ...
      <Card style={{ gridArea: 'main' }}>
        ...
        <CardContent>
          <Paragraph>
            The admin dashboard layout includes a header, sidebar, main content area, and footer.
            All areas are responsive and adapt to container size.
          </Paragraph>
        </CardContent>
      </Card>
      <Card style={{ gridArea: 'footer' }}>
        <CardContent>
          <Paragraph variant="small">System Status: All services operational</Paragraph>
        </CardContent>
      </Card>
    </Dashboard>
  </Story>
...
<Canvas>
  <Story name="Dashboard Guest">
    <Dashboard variant="guest" style={{ minHeight: '300px' }}>
      <Card style={{ gridArea: 'header' }}>
        <CardContent>
          <Heading level={3}>GUEST VIEW</Heading>
        </CardContent>
      </Card>
      <Card style={{ gridArea: 'main' }}>
        <CardHeader>
        ...
        <CardContent>
          <Paragraph>
            The guest dashboard variant provides a simpler layout without a sidebar.
            Perfect for public-facing pages or simplified views.
          </Paragraph>
        </CardContent>
      </Card>
      <Card style={{ gridArea: 'footer' }}>
        <CardContent>
          <Paragraph variant="small">Footer content</Paragraph>
        </CardContent>
      </Card>
    </Dashboard>
  </Story>
